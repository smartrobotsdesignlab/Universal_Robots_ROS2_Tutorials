...
def generate_launch_description():
    ...
    xacro_file_path = os.path.join(
        get_package_share_directory("my_dual_robot_cell_control"),  # Replace with your actual package
        "urdf",
        "my_dual_robot_cell_controlled.urdf.xacro"  # Replace with your actual Xacro file
    )

...
def launch_setup(context, *args, **kwargs):
    ...
    joint_limit_params = PathJoinSubstitution(
        [FindPackageShare("my_dual_robot_cell_control"), "config", bob_ur_type, "joint_limits.yaml"]
    )
    physical_params = PathJoinSubstitution(
        [FindPackageShare("my_dual_robot_cell_control"), "config", bob_ur_type, "physical_parameters.yaml"]
    )
    visual_params = PathJoinSubstitution(
        [FindPackageShare("my_dual_robot_cell_control"), "config", bob_ur_type, "visual_parameters.yaml"]
    )
    ...
    alice_robot_state_helper_node = Node(
        package="ur_robot_driver",
        ...
        parameters=[
            {"headless_mode": headless_mode},
            {"robot_ip": alice_robot_ip},
        ],
    )

    bob_robot_state_helper_node = Node(
        package="ur_robot_driver",
        executable="robot_state_helper",
        name="ur_robot_state_helper",
        output="screen",
    ...
    nodes_to_start = [
        ...
        alice_robot_state_helper_node,
        bob_robot_state_helper_node,
